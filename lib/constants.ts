...
export const SITE_NAME = 'African Stories';
export const SITE_DESCRIPTION = 'Discover bilingual African books in English and French';
      ...
      items: [
        {
          ...
          href: '/fr/books',
          description: 'Parcourez notre collection de livres africains bilingues',
        },
        {
